...
export default function ExecutionPanel({ skillId, onClose }: ExecutionPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-black/40" onClick={state === "running" ? undefined : close} />
      <div className="relative z-10 max-h-[85vh] w-full max-w-lg overflow-y-auto rounded-lg border border-[--color-border] bg-[--color-card] p-5 shadow-2xl">
        ...
        {state === "result" && executionResult && <ExecutionResult result={executionResult} onClose={close} />}
